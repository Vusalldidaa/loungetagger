...
async def start(event):
  await event.reply("**LoungeTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(https://t.me/loungetaggerbot?startgroup=a
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'http://t.me/WGTaggerBot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/WGBotlarim'),
                      Button.url('🚀 Sahibim', 'https://t.me/developerbyuu')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @https://t.me/WGBotlarim bilgi alabilirsin <<")
